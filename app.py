...
# load the pretrained nlp model and tfidf vectorizer from disk
filename = 'static/nlp_model.pkl'
clf = pickle.load(open(filename, 'rb'))
vectorizer = pickle.load(open('static/tranform.pkl','rb'))
...
def best_movies_by_genre(genre,top_n,year = 1920):
    movie_score = pd.read_csv('data/movie_score.csv')
